            ...
            <div class="order-date">
                ...
                @if(!empty($list->seller_approval_status))
                 <span class="left-buy-it">
                    ...
                    <b style="color:black"> Ref. Req: </b>Accepted
                    </span>
                    @elseif($list->seller_approval_status==2)
                    <span class="rejected-request">
                    <b style="color:black"> Ref. Req: </b>Rejected
                    </span>

                    @else
                    <span class="pending-request">
                    <b style="color:black"> Ref. Req: </b> Pending
                    </span>
                    @endif
        ...
        <div class="row">
            ...
            <div class="col-12 col-xs-12 col-sm-3 col-md-3 col-lg-3 bottom-shipping">
                <span class="refund-policy-1">
                    ...
                    //compare the dates
                    if($date1 < $date2){ $expiry=1; }else{ $expiry=0; } @endphp @php $refundProduct=new
                        App\Models\RefundRequest; $pro_id=idBasedOrderDetails($list->product_detail_1);
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-sm-12">
                <div class="shipping-menu" id="shipping_toggle-{{$index}}">
                    ...
                    <div class="track">
                        <div
                            class="step <?php if($list->delivery_status =='p' || $list->delivery_status =='s'||$list->delivery_status =='d'){echo 'active';} ?>">
                            <span class="icon">
                        ...
                        <div
                            class="step <?php if($list->delivery_status =='s'||$list->delivery_status =='d'){echo 'active';} ?>">
                            <span class="icon">
        ...
        <form method="post" enctype="multipart/form-data" id="refundProductRequest">
            ...
            <div class="refundRequestModel-body">
                ...
                <div>
                    ...
                    <div class="center">
                        <div class="form-input-refund-request">
                            <div class="preview">
                                <img id="file-ip-1-preview">
                            </div>
                            <label for="file-ip-1">Upload Document</label>
