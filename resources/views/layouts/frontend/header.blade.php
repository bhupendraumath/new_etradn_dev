    ...
    <div class="container-fluid">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <div class="money-back">
                <span class="yellow-color"> {{lang('MONEY_BACK')}}
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
            <ul class="right-menu">
                    ...
                    <div class="">
                        ...
                        <div class="dropdown-content">
                            <a href="{{route('set-language')}}">
                                (<img src="{{url('assets/images/frontend/british.png')}}" class="flag" alt="" srcset=""> English
                                @if($locale=='en')<img src="{{asset('assets/images/success.png')}}" hight="40" width="40">
                                @endif</a>
                            <a href="{{route('set-language')}}"><img src="{{url('assets/images/frontend/arabic.png')}}" class="flag" alt="" srcset="">Arabic
                                @if($locale=='ar')<img src="{{asset('assets/images/success.png')}}" hight="40" width="40">
                                @endif</a>
                        </div>
                    </div>
                </div>
