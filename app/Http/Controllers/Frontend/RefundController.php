    ...
    public function refund_request_list_post(Request $request)
    {
        ...
        if ($request->ajax()) {
            try {
                ...
                ->select('tbl_product.id','tbl_product.product_name','tbl_product.user_id','tbl_product.user_id','tbl_refund_details.id as ref_id', 'tbl_refund_details.*','tbl_product_image.product_img','tbl_product_image.product_id','tbl_orders.total_order_amount','tbl_product.want_to_list','tbl_product.cat_id','tbl_product.sub_cat_id','tbl_product.brand_id','tbl_product_cat.*','tbl_product_brand.*','tbl_product_sub_cat.*')
                ->join('tbl_product','tbl_product.id','=','tbl_refund_details.product_id')
                ->join('tbl_orders','tbl_orders.id','=','tbl_refund_details.order_item_id')
